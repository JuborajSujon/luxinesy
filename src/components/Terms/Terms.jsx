              ...
              <div className="md:w-3/4">
                <div className="p-6 bg-white dark:bg-slate-900 shadow dark:shadow-gray-700 rounded-md">
                  ...
                  <p className="text-slate-400">
                    These terms and conditions govern your use of our luxury
                    real estate services and website. By accessing or using our
                    services, you agree to comply with these terms and
                    conditions in full.
                  </p>
                  ...
                  <p className="text-slate-400">
                    ...
                    buyers, sellers, and agents. We reserve the right to modify
                    or discontinue any part of our services without prior
                    notice.
                  </p>
                  <p className="text-slate-400 mt-3">
                    <b className="text-green-500 text-lg">Property Listings:</b>{" "}
                    Property listings on our website are provided for
                    informational purposes only and do not constitute an offer
                    or contract. We make reasonable efforts to ensure the
                    accuracy of property information, but we do not guarantee
                    the completeness, accuracy, or reliability of any property
                  ...
                  <p className="text-slate-400 mt-3">
                    <b className="text-green-500 text-lg">Governing Law:</b>{" "}
                    These terms and conditions shall be governed by and
                    construed in accordance with the laws of [JIDB/2345],
                    without regard to its conflict of law provisions. Any
                    disputes arising out of or in connection with these terms
                    and conditions shall be resolved through arbitration in
                    [JIDB/2A/345].
                  </p>
                  <p className="text-slate-400 mt-3">
                    <b className="text-green-500 text-lg">Changes to Terms:</b>{" "}
                  ...
                  <ul className="list-none text-slate-400 mt-3">
                    ...
                    <li className="flex mt-2">
                      <BsArrowRight
                        ...
                        className="text-green-600 align-middle me-2"
                      />
                      Reproducing, distributing, or modifying any content from
                      our website without prior written consent is prohibited.
                    </li>
                    <li className="flex mt-2">
                      <BsArrowRight
                        size={20}
