        ...
        <div className="relative w-full">
          ...
          <div className="text-center mx-3">
            <p className="text-lg text-slate-400 italic">
              ...
              "by owner". My home sold in 24 hours for the asking price. Best
              $400 you could spend to sell your home.
              {'"'}
            </p>
          ...
          <div className="text-center mx-3">
            <p className="text-lg text-slate-400 italic">
              {'"'}My favorite part about selling my home myself was that we got
              to meet and get to know the people personally. This made it so
              much more enjoyable!{'"'}
            </p>
          ...
          <div className="text-center mx-3">
            ...
            <div className="text-center mt-5">
              ...
              <span className="text-slate-400 text-sm">General Manager</span>
            </div>
          </div>
